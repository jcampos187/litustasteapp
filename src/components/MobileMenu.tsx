...
export default function MobileMenu({ isAdmin = false }: MobileMenuProps) {
  ...
  return (
    <div className="md:hidden" ref={menuRef}>
      ...
      {/* Portal: Panel always mounted for smooth animation, overlay conditional */}
      {typeof window !== "undefined" && createPortal(
        <>
          ...
          >
            ...
            <div className="flex items-center justify-between px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  <span className="font-[family-name:var(--font-display)] text-lg font-semibold leading-tight tracking-tight text-white">
              ...
              <button
                onClick={() => setIsOpen(false)}
                className="flex h-10 w-10 items-center justify-center rounded-xl text-white/40 transition-all hover:bg-white/10 hover:text-white"
            ...
            {isSignedIn && user && (
              <div className="mx-4 mb-2 flex items-center gap-3 rounded-2xl bg-white/8 px-4 py-3.5">
            ...
            <nav className="flex-1 space-y-0.5 overflow-y-auto px-4 py-3">
              <p className="px-3 pb-2 text-[11px] font-semibold uppercase tracking-[0.15em] text-white/30">
                Navegación
              </p>
              <Link
                href="/"
